...
Documentation: This project requires the user to upload CSV files containing information about different supply locations, villages and information about food/water/medical supply. The website is structured to showcase information easily and allow the user to upload data seamlessly. The user also has access to an AI model for fast real time guidance.
